...
LUA_SHA1 = get_hash(os.path.join(CWD, 'inkblazers.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            "--timeout", "30",
            "--tries", "inf",
            "--domains", "inkblazers.com",
            "--span-hosts",
            "--waitretry", "30",
            "--warc-file", ItemInterpolation("%(item_dir)s/%(warc_file_base)s"),
            "--warc-header", "operator: Archive Team",
            "--warc-header", "inkblazers-dld-script-version: " + VERSION,
            "--warc-header", ItemInterpolation("inkblazers-user: %(item_name)s"),
        ]
...
project = Project(
    title="inkblazers",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/4/46/Inkblazerslogo.png" height="50px" title=""/>
        <h2>www.inkblazers.com <span class="links"><a href="http://www.inkblazers.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/inkblazers/">Leaderboard</a></span></h2>
        <p>Grabbing all inkblazers comics.</p>
    """
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="inkblazers"),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
